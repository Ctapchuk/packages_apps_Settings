...
public class SoundDolbySwitchPreferenceController extends AbstractPreferenceController
        implements OnMainSwitchChangeListener, LifecycleObserver, OnResume, OnPause {
    ...
    public void displayPreference(PreferenceScreen preferenceScreen) {
    	mSwitch = (SettingsMainSwitchPreference) preferenceScreen.findPreference(getPreferenceKey());
        super.displayPreference(preferenceScreen);
        if (!isAvailable() || mSwitch == null) {
            return;
        }
        mSettingObserver = new SettingObserver(mSwitch);
        if (mSwitch != null) {
    ...
    protected void setChecked(boolean checked) {
        SettingsMainSwitchPreference switchBar = mSwitch;
        if (switchBar != null) {
